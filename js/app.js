// Redesigned by https://github.com/RohanTrix from https://github.com/RohanTrix/Google-Drive-Index which was written by someone else, credits are given on Source Page.
// v2.0.15
// Initialize the page
function init() {
...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <a class="nav-link" href="${UI.contact_link}" target="github.com/RohanTrix">Contact</a>
  </li>`;
